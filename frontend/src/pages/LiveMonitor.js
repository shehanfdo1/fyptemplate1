...
const LiveMonitor = () => {
    ...
    useEffect(() => {
        ...
        socket.on('alert', (data) => {
            ...
            // Isolate socket feeds to the active user explicitly!
            const currentUser = localStorage.getItem('username');
            if (data.username && currentUser && data.username !== currentUser) {
                return; // Suppress alerts generated by other accounts
            }
